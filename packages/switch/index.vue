...
const classes = computed(() => {
  return {
    [`cm-switch-checked`]: modelValue.value,
    [`cm-switch-disabled`]: disabled.value,
    [`cm-switch-${size.value}`]: size.value,
  };
});
</script>
<script lang="ts">
...
.cm-switch {
  ...
  &.cm-switch-checked {
    ...
    &.cm-switch-small > span {
      left: calc(100% - $small-h-2 - 2px);
    }

    &.cm-switch-large > span {
